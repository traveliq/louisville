...
Requiring this gem adds several methods to String, the most important are:

String#asciify - replaces all non-ASCII chars with their nearest equivalent, or removes them.
String#normalize - does the same, and also does a lot of wrangling to get a normalized string that serves as a canonical representation
of the input. It replaces abbreviations like St. or St to Sankt, moves post-fixed "the"s around, and other stuff.
